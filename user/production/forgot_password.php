<?php
require_once 'inc/web/header.php';
                        ...
                        <div class="forgotPasswordForm">
                            <form id="forgotPasswordForm" method="post" action="#" class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12" style="margin: 15px 0; text-align: center;">
                                    <p><a href="login.html" target=""><i class="fal fa-long-arrow-left" style="margin-right: 10px;"></i>Back to Login</a></p>
...
<?php
require_once 'inc/web/footer.php';
?>
<script>
